...
async def edit_task(item_id: int, request: Request, db: Session = Depends(get_db), date_sequence = date_sequence, today_date = today_date, link: str = Query(None), skip: int = 0, limit: int = 10):
# async def edit_task(item_id: int, request: Request, db: Session = Depends(get_db), date_sequence = date_sequence, today_date = today_date, link: str = Query(None), action: str = Form(...)):
    # if action == "update":
    ...
    print(db_item.start_datetime.date())
    print("utc_start_datetime", utc_start_datetime)
    print("utc_end_datetime", utc_end_datetime)
    print("local_start_datetime", local_start_datetime)
    print("local_end_datetime", local_end_datetime)
    print("selected_local_start_date", selected_local_start_date)
    print("selected_local_start_time", Selected_local_start_time)
    print("selected_local_end_time", selected_local_end_time)
    ...
    if db_item:
        return templates.TemplateResponse("schedule_edit_00.html", {"request": request, "item": db_item, "df_combined": df_combined_dict, "dates": date_sequence, "today": today_date, "time_zone": time_zone, "login_username": login_username, "selected_local_start_date": selected_local_start_date, "selected_local_start_time": Selected_local_start_time, "selected_local_end_time": selected_local_end_time, "tab_page_active": tab_page_active})
...
async def create_item(request: Request, item_id: int, action: str = Form(...), name: str = Form(...), date1: str = Form(...), start_time: str = Form(...), end_time: str = Form(...), link: str = Form(None), category: str = Form(None), status: str = Form(None), username: str = Form(None), time_zone: str = Form(None), db: Session = Depends(get_db), skip: int = 0, limit: int = 10):
